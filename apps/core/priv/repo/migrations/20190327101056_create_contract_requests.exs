defmodule Core.Repo.Migrations.CreateContractRequests do
  use Ecto.Migration

  def change do
    create table(:contract_requests, primary_key: false) do
      add(:id, :uuid, primary_key: true)
      add(:contractor_legal_entity_id, :uuid)
      add(:contractor_owner_id, :uuid)
      add(:contractor_base, :string)
      ...
      add(:updated_by, :uuid)
      add(:contractor_divisions, {:array, :uuid})
